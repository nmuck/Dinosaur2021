...
/**
 * Write a description of class pterydactyl here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class pterydactyl extends Dinosaur
{
    // instance variables - replace the example below with your own
    private int x;

    /**
     * Constructor for objects of class pterydactyl
     */
    public pterydactyl()
    {
        super("pterydactyl");
